...
lemlib::TrackingWheel horizontal_tracking_wheel(&rotation, lemlib::Omniwheel::NEW_2, -4.5);
...
lemlib::ControllerSettings linearController(5.2, // proportional gain (kP) 5.58
                                            0, // integral gain (kI) 
                                            5.5, // derivative gain (kD) 19.05
                                            3, // anti windup
