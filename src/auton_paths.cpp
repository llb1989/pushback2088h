...
void right_auto() {
    ...
    pros::delay(500);
    littlewill.toggle();
    chassis.turnToPoint(31, 18,600, {.maxSpeed = 50});
    chassis.moveToPoint(31, 18, 1000);

    chassis.turnToHeading(180, 1050);
    pros::delay(100); 
    chassis.moveToPoint(31, -6, 700, {.maxSpeed = 70});
    chassis.turnToHeading(180, 500);
    pros::delay(400);
    chassis.moveToPoint(32, -8, 500, {.maxSpeed = 90});
    pros::delay(300);
    ...
    chassis.moveToPoint(21, 47, 2000, {.forwards = false, .maxSpeed = 50});
    pros::delay(10); //
}
...
void sawp(){
    ...
    chassis.moveToPoint(38, 0, 1000 , {.maxSpeed = 90});
    littlewill.toggle();
    intakeone(12000);
    chassis.turnToHeading(180, 900); // turn to matchload>
    chassis.moveToPoint(38, -14, 1000, {.maxSpeed = 90}); // move to matchload>
    pros::delay(1200);


    chassis.moveToPoint(38, 16.556, 1200, { .forwards = false ,.maxSpeed = 100});
    pros::delay(650);

    intakeall(12000);
    pros::delay(1000);
    intakeone(12000);
    chassis.moveToPoint(38, 0, 500 , {.maxSpeed = 90}); // pull out?
    chassis.turnToHeading(-45, 400);
    
    littlewill.toggle();
    chassis.moveToPoint(17, 24, 750, {.maxSpeed = 90});
    pros::delay(500);
    //chassis.moveToPoint(8, 35, 1000, {.forwards = false, .maxSpeed = 90});
    chassis.turnToHeading(-90, 1000);


    chassis.moveToPoint(-32.5, 23.5, 1500 , {.forwards = true, .maxSpeed = 90});
    pros::delay(1000);
    littlewill.toggle();


    chassis.turnToHeading(225, 500);
    chassis.moveToPoint(-21, 32, 1500, {.forwards = false, .maxSpeed = 90});
    pros::delay(500);
    intakeone(0);
    chassis.turnToHeading(205, 200);
        intakemiddle(12000);
    pros::delay(750);
    intakeone(0);
    pros::delay(100);
    chassis.moveToPoint(-56, 4, 1600, {.minSpeed = 40});
    chassis.turnToHeading(180, 500);
chassis.turnToHeading(180, 500);
    chassis.moveToPoint(-56, 17, 500 , {.forwards = false, .minSpeed = 50});
    pros::delay(750);
    intakeall(120000);
