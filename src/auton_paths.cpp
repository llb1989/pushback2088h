...
//turn theta from degrees to radians because cos and sin calculations require radians
...
//using new coordinates, moveToPose
...
void test(){
        driveRelative(10, 1000, 127, 127);
    chassis.turnToHeading(50, 500);
    driveRelative(20, 1000, 127, 127);
...
void right_auto() { 
    ...
    pros::delay(500);
    littlewill.toggle();
    chassis.turnToPoint(31, 18,700, {.maxSpeed = 100});
    chassis.moveToPoint(31, 18, 1200);
    ...
    pros::delay(100);
    intakeone(8000);
    chassis.moveToPoint(31, 2, 750, {.maxSpeed = 100});
    chassis.moveToPoint(31, -1, 100, {.minSpeed = 80});

    chassis.moveToPoint(31, 41, 1200, {.forwards = false, .minSpeed = 40});
    chassis.turnToHeading(180, 300);
    pros::delay(800);
    intakeall(12000);
    pros::delay(1500); // commit
    ...
    pros::delay(1400);
    intakeall(0);
    chassis.moveToPoint(20.5, 28, 1200, {.minSpeed = 35});// og 20.5
    chassis.moveToPoint(30, 30, 2000, {.forwards = false, .maxSpeed = 100, .minSpeed = 35});
...
void sawp(){
    ...
    chassis.moveToPoint(0, 38, 1000, {.forwards = true, .maxSpeed = 90});
...
pros::delay(900);
    ...
    chassis.moveToPoint(-6, -59, 800, {.maxSpeed = 80, .minSpeed = 10}); // move to other quadrant
    chassis.waitUntilDone();

    chassis.turnToHeading(90, 300);
    chassis.moveToPoint(-28, -59, 800, {.forwards = false, .maxSpeed = 80});
    chassis.waitUntilDone();
    intakeall(12000);
    pros::delay(1400); // score long goal
    intakeone(12000);
    chassis.moveToPoint(18, -58, 1250, {.forwards = true, .maxSpeed = 70, .minSpeed = 20});
    pros::delay(150);

    chassis.moveToPoint(0, -58, 700, {.forwards = false, .maxSpeed = 90, .minSpeed = 30}); //pull out
    chassis.waitUntilDone();

    chassis.turnToHeading(135, 600);

    chassis.moveToPoint(-45.5, -14.8, 1300, {.forwards = false, .maxSpeed = 70, .minSpeed = 30});
    chassis.waitUntilDone();
    intakeall(-12000);
    pros::delay(200);
    intakemiddle(12000);
