...
void autonomous() {
    ...
    switch (13){
        ...
        pros::delay(20);
        intakeone(12000);
        // chassis.moveToPoint(0, 38, 1100, {.forwards = true, .maxSpeed = 80}); // first loader right side
        // littlewill.toggle();
        ...
        // chassis.waitUntilDone();
        // pros::delay(20);
        // lemreset(true, 3, true, false, true, -120, 16, -76, 58, true); // reset epstein
        // pros::delay(20);
        // chassis.turnToHeading(270, 1000);

        // chassis.moveToPoint(-90, 62, 3000, {.forwards = true, .maxSpeed = 100, .minSpeed = 20}); // next quadrant
        // littlewill.toggle();
        // chassis.waitUntilDone();
        // chassis.turnToHeading(180, 600);
        // chassis.waitUntilDone();
        // chassis.moveToPoint(-90, 70, 600, {.forwards = false, .maxSpeed = 90, .minSpeed = 10}); // line up to goal
        // littlewill.toggle();
        // chassis.waitUntilDone();
        ...
        // chassis.moveToPoint(-90, 40, 1000, {.forwards = true, .maxSpeed = 80}); // make 40
        // chassis.waitUntilDone();
        // chassis.turnToHeading(270, 800);
        // chassis.waitUntilDone();
        // chassis.moveToPoint(-80, 40, 800, {.forwards = false, .maxSpeed = 110, .minSpeed = 50}); // score long goal
        // chassis.waitUntilDone();
        // intakeall(12000);
        // pros::delay(1000);
        // intakeall(12000);
        ...
        // chassis.moveToPoint(-115, 40, 800, {.forwards = true, .maxSpeed = 80}); // matchload 
        // pros::delay(500);
        // chassis.moveToPoint(-116.5, 40, 800, {.forwards = true, .maxSpeed = 90}); // matchload
        // pros::delay(500);
        ...
        // intakeall(-12000); // why????????? ############# change later?
        // chassis.moveToPoint(-107, -80, 3000, {.forwards = false, .maxSpeed = 100, .minSpeed = 20}); // other half i think
        // chassis.turnToHeading(0, 600);
        // chassis.waitUntilDone();
        ...
        pros::delay(20);
        intakeone(12000);
        chassis.moveToPoint(-100, -56, 800, {.forwards = true, .maxSpeed = 90, .minSpeed = 10});
        chassis.turnToHeading(270, 600);

        chassis.moveToPoint(-116, -54, 1000, {.forwards = true, .maxSpeed = 70}); // matchloader
        pros::delay(500); 
        chassis.moveToPoint(-117.5, -54, 1000, {.forwards = true, .maxSpeed = 70}); // matchloader
        pros::delay(500); 
        ...
        littlewill.toggle();
        chassis.moveToPoint(-10, -78, 3200, {.forwards = true, .maxSpeed = 100, .minSpeed = 20}); // keep going 
        chassis.turnToHeading(0, 600); // og angle
        chassis.moveToPoint(-10, -84, 1000, {.forwards = false, .maxSpeed = 90, .minSpeed = 20});
        chassis.waitUntilDone();
        pros::delay(200);
        lemreset(true, 1, false, true, true, -120, 16, -73, 58, true); // reset 4th quad?
        pros::delay(200);
        chassis.turnToHeading(0, 200); // og angle
        chassis.moveToPoint(-10, -58, 1000, {.forwards = true, .maxSpeed = 90, .minSpeed = 20}); // off wall reset
        chassis.waitUntilDone();
        chassis.turnToHeading(90, 600);
        littlewill.toggle();
        chassis.waitUntilDone();
        
        chassis.moveToPoint(-25, -56, 800, {.forwards = false, .maxSpeed = 90}); // score left bottom?
        chassis.waitUntilDone();
        intakeall(12000);
        pros::delay(2000);
        intakeone(12000);
        chassis.moveToPoint(16, -56, 1000, {.forwards = true, .maxSpeed = 70}); // matchload again i think
        pros::delay(500);
        chassis.moveToPoint(17.5, -56, 200, {.forwards = true, .maxSpeed = 90}); // matchlaod again i think
        pros::delay(500);
        ...
        chassis.moveToPose(20, -14, 0, 2000, {.forwards = true}); // set up for park, moce towards
        chassis.waitUntilDone();
        pros::delay(20);
        lemreset(true, 1, false, true, false, -120, 16, -73, -58, true);
        pros::delay(50);
        chickenstars.toggle();
        chassis.moveToPoint(20, -12, 2000, {.forwards = true});
        littlewill.toggle();
        chassis.waitUntilDone();
        
        chassis.moveToPoint(20, -4, 2000, {.forwards = true}); // was -4
